    ...
    return (
      <div>
        ...
        <Container>
          <Row>
            <Form
              style={{ flex: 1, marginTop: "-13px" }}
              onSubmit={this.onSubmit}
            >
              <FormGroup>
                <Label for="exampleName">
                  <h4 style={{ color: "#fff" }}>Connect Topictest</h4>
                </Label>
                <Input
                  type="select"
                  name="selectMulti"
                  ...
                  multiple
                  onChange={this.onChange_topicname}
                  style={{ height: "150px" }}
                >
...
export default connect(mapStateToProps, { postTopic, set_Topic, getTopics })(
  ConnectTopic
);
